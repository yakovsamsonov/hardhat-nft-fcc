...
/// @title A contract to mint dog NFT
/// @author Yakov Samsonov
/// @notice When we mint NFT, we will trigger Chainlink VRF call to get a random number
/// @notice using that number we will get a random NFT
/// @notice Pug (super rare), Shiba (rare) or St. Bernard (common)
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    event NftMinted(Breed dogBreed, address mintor);
